...
cover: /blog/agent-reliability-is-a-systems-problem/cover.svg
---
...
**Boundaries.** A tool-using agent runs real actions against real state:
...
does the most damage and where teams instrument the least.

## What I do instead

I treat the agent as a distributed system whose inputs I don't trust
...
tuning the prose. The prompt is the last thing I touch, not the first.
